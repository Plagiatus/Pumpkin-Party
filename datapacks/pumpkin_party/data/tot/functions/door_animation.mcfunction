...
execute run tp @p[tag=tot_tricking,dy=0] @s
...
#Trick or Treat
execute if entity @s[tag=!tot_witch,scores={timer=33}] run tellraw @p[tag=tot_tricking,dy=0] ["",{"text":"Treated! +","color":"green"},{"score":{"name":"@s","objective":"points"},"color":"green"},{"text":"\nChocolate Emeralds: ","color":"gold"},{"score":{"name":"@p[tag=tot_tricking,dy=0]","objective":"tot_treats"},"color":"gold"}]
execute if entity @s[tag=tot_witch,scores={timer=33}] run tellraw @p[tag=tot_tricking,dy=0] ["",{"text":"Tricked! ","color":"red"},{"score":{"name":"@s","objective":"points"},"color":"red"},{"text":"\nChocolate Emeralds: ","color":"gold"},{"score":{"name":"@p[tag=tot_tricking,dy=0]","objective":"tot_treats"},"color":"gold"}]
