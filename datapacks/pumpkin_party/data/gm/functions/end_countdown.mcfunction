...
execute if score gm_difficulty settings matches 1.. as @e[limit=1,type=armor_stand,name=gm_center,sort=random] at @s run function gm:summon_zombie
execute if score gm_difficulty settings matches 2.. as @e[limit=1,type=armor_stand,name=gm_center,sort=random] at @s run function gm:summon_zombie
