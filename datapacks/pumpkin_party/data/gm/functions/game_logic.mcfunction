...
execute if score #gm_playerCount tmp < #gm_playerCount const as @e[limit=1,type=armor_stand,name=gm_center,sort=random] at @s positioned ~ ~1 ~ run function gm:summon_zombie
