...
execute as @p[tag=gm_highscore] if score @s gm_highscore_sec matches ..9 run data merge block 394 87 514 {Text2:'[{"color":"gold","score":{"name":"@p[tag=gm_highscore]","objective":"gm_highscore_min"}},{"text":":0"},{"score":{"name":"@p[tag=gm_highscore]","objective":"gm_highscore_sec"}}]',Text4:'{"color":"#FF6600","selector":"@a[tag=gm_highscore]"}'}
execute as @p[tag=gm_highscore] if score @s gm_highscore_sec matches 10.. run data merge block 394 87 514 {Text2:'[{"color":"gold","score":{"name":"@p[tag=gm_highscore]","objective":"gm_highscore_min"}},{"text":":"},{"score":{"name":"@p[tag=gm_highscore]","objective":"gm_highscore_sec"}}]',Text4:'{"color":"#FF6600","selector":"@a[tag=gm_highscore]"}'}
