...
scoreboard players reset * gm_highscore_sec
scoreboard players reset * gm_highscore_min
scoreboard players reset * pc_highscore
...
scoreboard players set #gm_highscore gm_highscore_sec 0
scoreboard players set #gm_highscore gm_highscore_min 0
scoreboard players set #pc_highscore pc_highscore 0
