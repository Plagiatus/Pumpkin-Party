...
execute if score sr_difficulty settings matches 2 run title @s actionbar [{"text": "Distance to spider: ","color": "#ff6600"},{"text":"66","obfuscated": true},".",{"text":"6","obfuscated": true},"m"]