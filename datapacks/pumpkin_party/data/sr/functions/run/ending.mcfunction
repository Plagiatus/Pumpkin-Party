...
execute if score #sr_end sr_time matches 10.. as @a[team=sr_play,tag=!sr_caught] run function sr:run/display_actionbar
execute if score #sr_end sr_time matches 9 run tellraw @a[team=sr_play,tag=!sr_caught] [""]

# "catch" players
execute if score #sr_end sr_time matches 1.. at @e[tag=sr_spider] positioned ~ ~-5 ~-7 as @a[dx=3,dy=10,dz=15,tag=!sr_caught] run function sr:run/caught_late
execute if score #sr_end sr_time matches ..0 at @e[tag=sr_spider] positioned ~ ~-5 ~-7 as @a[dx=5,dy=10,dz=15,tag=!sr_caught] run function sr:run/caught_late
