...
execute if score #sr_cutscene sr_time matches 241 as @e[tag=sr_spider,limit=1] at @s run summon cave_spider ~2 ~2.8 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Rotation:[-90F,21F],Tags:["sr_spider_spider"],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:10000000,show_particles:0b}],PersistenceRequired:1b}
