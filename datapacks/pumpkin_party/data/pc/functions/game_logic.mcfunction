...
execute at @a[scores={pc_carved_block=1..}] as @e[type=minecraft:area_effect_cloud,limit=1,sort=nearest,distance=..15] at @s if blocks ~ ~ ~ ~8 ~ ~8 ~ ~-3 ~ all run function pc:next_template
