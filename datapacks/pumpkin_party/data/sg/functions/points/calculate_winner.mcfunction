...
# show ranking
execute if score #rank tmp matches 1 as @a[tag=sg_lead] run tellraw @a [{"color":"#ffd700","text":""},{"score": {"name": "#rank","objective": "tmp"}},". ",{"selector": "@s","color":"#ffd700"}, " with ", {"score": {"name": "@s","objective": "sg_points"}}, " points ",{"text":"(+","color":"gray"},{"score": {"name": "@s","objective": "sg_points_tmp"},"color":"gray"},{"text":" candies)","color":"gray"}]
execute if score #rank tmp matches 2 as @a[tag=sg_lead] run tellraw @a [{"color":"#c0c0c0","text":""},{"score": {"name": "#rank","objective": "tmp"}},". ",{"selector": "@s","color":"#c0c0c0"}, " with ", {"score": {"name": "@s","objective": "sg_points"}}, " points ",{"text":"(+","color":"gray"},{"score": {"name": "@s","objective": "sg_points_tmp"},"color":"gray"},{"text":" candies)","color":"gray"}]
execute if score #rank tmp matches 3 as @a[tag=sg_lead] run tellraw @a [{"color":"#cd7f32","text":""},{"score": {"name": "#rank","objective": "tmp"}},". ",{"selector": "@s","color":"#cd7f32"}, " with ", {"score": {"name": "@s","objective": "sg_points"}}, " points ",{"text":"(+","color":"gray"},{"score": {"name": "@s","objective": "sg_points_tmp"},"color":"gray"},{"text":" candies)","color":"gray"}]
execute if score #rank tmp matches 4.. as @a[tag=sg_lead] run tellraw @a [{"color":"white","text":""},{"score": {"name": "#rank","objective": "tmp"}},". ",{"selector": "@s","color":"white"}, " with ", {"score": {"name": "@s","objective": "sg_points"}}, " points ",{"text":"(+","color":"gray"},{"score": {"name": "@s","objective": "sg_points_tmp"},"color":"gray"},{"text":" candies)","color":"gray"}]
