...
execute if score @s[tag=ul_zombified_piglin] costume matches 3017 run function lobby:costume/zombified_piglin
execute if score @s[tag=!ul_zombified_piglin] costume matches 3017 run function lobby:costume/info/zombified_piglin
...
execute if score @s[tag=ul_piglin] costume matches 3117 run function lobby:costume/piglin
execute if score @s[tag=!ul_piglin] costume matches 3117 run function lobby:costume/info/piglin
...
execute if score @s[tag=ul_piglin_brute] costume matches 3217 run function lobby:costume/piglin_brute
execute if score @s[tag=!ul_piglin_brute] costume matches 3217 run function lobby:costume/info/piglin_brute
...
execute if score @s[tag=ul_piglin_chan] costume matches 3317 run function lobby:costume/piglin_chan
execute if score @s[tag=!ul_piglin_chan] costume matches 3317 run function lobby:costume/info/piglin_chan
