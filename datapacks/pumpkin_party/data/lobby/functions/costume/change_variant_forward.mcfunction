...
execute at @s[tag=horse_costume] run scoreboard players add @e[type=armor_stand,distance=0.1..3,tag=horse_costume] costume 100
...
#Horse
execute if score @s[tag=horse_costume] costume matches 700..769 run scoreboard players remove @e[type=armor_stand,distance=0.1..3,tag=horse_costume] costume 700
