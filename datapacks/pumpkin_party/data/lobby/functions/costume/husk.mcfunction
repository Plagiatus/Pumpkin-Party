...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:143,Unbreakable:1,display:{Name:'{"text":"Husk Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Husk Costume","italic":false}',color:15125652},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
