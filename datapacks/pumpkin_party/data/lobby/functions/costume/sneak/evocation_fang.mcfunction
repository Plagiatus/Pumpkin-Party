...
replaceitem entity @s armor.head minecraft:iron_nugget{CustomModelData:1007,Unbreakable:1,display:{Name:'{"text":"Evocation Fang Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
