...
execute anchored eyes run summon armor_stand ^ ^ ^0.5 {Pose:{Head:[0.1f,0.1f,0.1f]},Invisible:1b,DisabledSlots:4144959,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:iron_nugget",Count:1b,tag:{CustomModelData:103}}],Tags:["lobby_shoot_forward","wither_skull","picture","new"]}
