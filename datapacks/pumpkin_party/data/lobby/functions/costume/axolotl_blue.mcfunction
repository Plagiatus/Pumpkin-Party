...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Axolotl (Blue) Costume","italic":false}',color:11776249},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
