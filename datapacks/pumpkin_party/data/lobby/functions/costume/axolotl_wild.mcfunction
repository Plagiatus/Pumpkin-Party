...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Axolotl (Wild) Costume","italic":false}',color:8085576},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
