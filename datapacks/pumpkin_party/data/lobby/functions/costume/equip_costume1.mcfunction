...
execute if score @s[tag=ul_pufferfish] costume matches 6 run function lobby:costume/pufferfish
execute if score @s[tag=!ul_pufferfish] costume matches 6 run function lobby:costume/info/pufferfish
