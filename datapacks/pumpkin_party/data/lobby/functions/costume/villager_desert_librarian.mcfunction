...
item replace entity @s armor.head with iron_nugget{CustomModelData:470,Unbreakable:1,display:{Name:'{"text":"Villager Costume","italic":false}',Lore:['{"text":"hmmm..."}']},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Villager Costume","italic":false}',color:15973487},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
