...
item replace entity @s armor.head with iron_nugget{CustomModelData:122,Unbreakable:1,display:{Name:'{"text":"Cave Spider Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Cave Spider Costume","italic":false}',color:11826},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
