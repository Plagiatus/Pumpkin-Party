...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:6631,Unbreakable:1,display:{Name:'{"text":"Zombie Horse Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{CustomModelData:1,Unbreakable:1,display:{Name:'{"text":"Zombie Horse Costume","italic":false}',color:6987098},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
