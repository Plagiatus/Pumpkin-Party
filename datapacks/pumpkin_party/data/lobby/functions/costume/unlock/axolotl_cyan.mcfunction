...
tellraw @s[advancements={lobby:unlocked/axolotl_cyan=true},tag=!tmp_all_costumes,tag=!ul_axolotl_cyan] ["",{"text":"Password: "},{"text":"\"THEHEALINGPOWEROFFRIENDSHIP\"","underlined":true,"color":"dark_green","clickEvent":{"action":"copy_to_clipboard","value":"THEHEALINGPOWEROFFRIENDSHIP"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to copy the password to your clipboard."}}}]
