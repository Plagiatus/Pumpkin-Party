...
tellraw @s[tag=!tmp_all_costumes,tag=!ul_fox] ["",{"text":"Password: "},{"text":"\"SLAYEROFCHICKENS\"","underlined":true,"color":"dark_green","clickEvent":{"action":"copy_to_clipboard","value":"SLAYEROFCHICKENS"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to copy the password to your clipboard."}}}]
