...
tellraw @s[advancements={lobby:unlocked/axolotl_blue=true},tag=!tmp_all_costumes,tag=!ul_axolotl_blue] ["",{"text":"Password: "},{"text":"\"MUSICALENTHUSIAST\"","underlined":true,"color":"dark_green","clickEvent":{"action":"copy_to_clipboard","value":"MUSICALENTHUSIAST"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to copy the password to your clipboard."}}}]
