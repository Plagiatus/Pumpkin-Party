...
tellraw @s[advancements={lobby:unlocked/axolotl_green=true},tag=!tmp_all_costumes,tag=!ul_axolotl_green] ["",{"text":"Password: "},{"text":"\"BETALOTL\"","underlined":true,"color":"dark_green","clickEvent":{"action":"copy_to_clipboard","value":"BETALOTL"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to copy the password to your clipboard."}}}]
