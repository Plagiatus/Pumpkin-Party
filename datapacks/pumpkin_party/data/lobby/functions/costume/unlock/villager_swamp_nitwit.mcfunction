...
tellraw @s[tag=!tmp_all_costumes,tag=!ul_villager_swamp_nitwit] ["",{"text":"Password: "},{"text":"\"NOVILLAGE?NOWORK!\"","underlined":true,"color":"dark_green","clickEvent":{"action":"copy_to_clipboard","value":"NOVILLAGE?NOWORK!"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to copy the password to your clipboard."}}}]
