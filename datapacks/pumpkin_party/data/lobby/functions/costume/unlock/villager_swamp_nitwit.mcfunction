#First Time 
tellraw @s[advancements={lobby:unlocked/villager_swamp_nitwit=true},tag=!tmp_all_costumes,tag=!ul_villager_swamp] ["",{"text":"You successfully unlocked: ","color":"gold"},{"text":"\"Swamp Villager Costume\""}]
tellraw @s[advancements={lobby:unlocked/villager_swamp_nitwit=true},tag=!tmp_all_costumes,tag=!ul_villager_swamp] ["",{"text":"Password: "},{"text":"\"NOVILLAGE?NOWORK!\"","underlined":true,"color":"dark_green","clickEvent":{"action":"copy_to_clipboard","value":"NOVILLAGE?NOWORK!"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to copy the password to your clipboard."}}}]
