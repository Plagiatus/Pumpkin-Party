...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:345,Unbreakable:1,display:{Name:'{"text":"Piglin Chan Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
