...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:3317,Unbreakable:1,display:{Name:'{"text":"Piglin Chan Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Piglin Chan Costume","italic":false}',color:7026980},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
