...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:366,Unbreakable:1,display:{Name:'{"text":"Llama Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
