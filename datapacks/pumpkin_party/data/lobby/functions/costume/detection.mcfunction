...
execute positioned ~-1 ~ ~-1 run scoreboard players operation @s[type=player,tag=!in_costume] costume = @e[type=armor_stand,dy=0.5,dx=0.25,dz=0.25,limit=1,tag=Costume] costume
execute as @s[type=player,tag=!in_costume] positioned ~-1 ~ ~-1 if entity @e[type=armor_stand,dy=0.5,dx=0.25,dz=0.25,limit=1,tag=Costume] run tag @s remove got_costume
...
execute if entity @s[type=player] positioned ~-1 ~ ~-1 unless entity @e[type=armor_stand,dy=0.5,dx=0.25,dz=0.25,limit=1,tag=Costume] run tag @s remove in_costume