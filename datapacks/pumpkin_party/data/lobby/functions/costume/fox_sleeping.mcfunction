...
replaceitem entity @s armor.head iron_nugget{CustomModelData:1141,Unbreakable:1,display:{Name:'{"text":"Fox Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
...
playsound minecraft:entity.fox.sleep master @a ~ ~ ~