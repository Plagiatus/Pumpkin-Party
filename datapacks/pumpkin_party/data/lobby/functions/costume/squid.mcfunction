...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:1024,Unbreakable:1,display:{Name:'{"text":"Squid Costume","italic":false}',Lore:['{"text":"Blub blub blibl blub!"}','{"text":"Translation:"}','{"text":"\'Ello! nice to meet you!\'"}']},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
...
scoreboard players set @s costume 1024
