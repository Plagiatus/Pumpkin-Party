...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:369,Unbreakable:1,display:{Name:'{"text":"Black Horse Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
...
scoreboard players set @s costume 369
