...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:6231,Unbreakable:1,display:{Name:'{"text":"Gray Horse Costume","italic":false}'},HideFlags:127,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
