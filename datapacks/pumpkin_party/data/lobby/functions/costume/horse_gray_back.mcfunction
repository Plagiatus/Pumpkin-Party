...
replaceitem entity @s armor.head minecraft:iron_nugget{CustomModelData:269,Unbreakable:1,display:{Name:'{"text":"Gray Horse Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
