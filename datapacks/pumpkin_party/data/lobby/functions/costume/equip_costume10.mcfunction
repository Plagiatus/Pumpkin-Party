...
execute if score @s costume matches 10007 run function lobby:costume/sneak/shulker_close
execute if score @s costume matches 10013 run function lobby:costume/sneak/strider
execute if score @s costume matches 10015 run function lobby:costume/sneak/ghast
execute if score @s costume matches 10032 run function lobby:costume/sneak/bee
...
execute if score @s costume matches 16408 run function lobby:costume/sneak/evocation_fang
execute if score @s costume matches 16608 run function lobby:costume/sneak/ravager

execute if score @s costume matches 20000 run function lobby:costume/error
