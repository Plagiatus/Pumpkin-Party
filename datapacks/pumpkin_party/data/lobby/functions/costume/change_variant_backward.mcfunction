...
execute at @s[tag=horse_costume] run scoreboard players remove @e[type=armor_stand,distance=0.1..3,tag=horse_costume] costume 100
...
#Horse
execute if score @s[tag=horse_costume] costume matches -32..-31 run scoreboard players add @e[type=armor_stand,distance=..5,tag=horse_costume] costume 700
