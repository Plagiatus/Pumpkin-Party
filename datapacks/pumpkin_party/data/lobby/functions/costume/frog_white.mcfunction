...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:2120,Unbreakable:1,display:{Name:'{"text":"Frog Costume","italic":false}'},HideFlags:127,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
