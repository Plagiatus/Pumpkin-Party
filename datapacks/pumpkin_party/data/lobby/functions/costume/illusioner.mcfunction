...
item replace entity @s armor.head with iron_nugget{CustomModelData:467,Unbreakable:1,display:{Name:'{"text":"Illusioner Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Illusioner Costume","italic":false}',color:1267859},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
