...
item replace entity @s armor.head with iron_nugget{CustomModelData:2110,Unbreakable:1,display:{Name:'{"text":"Headless Horseman Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{CustomModelData:1,Unbreakable:1,display:{Name:'{"text":"Headless Horseman Costume","italic":false}',color:3420207},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
