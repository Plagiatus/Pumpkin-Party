...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:6531,Unbreakable:1,display:{Name:'{"text":"Mule Costume","italic":false}'},HideFlags:127,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
