...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Axolotl (Gold) Costume","italic":false}',color:15380033},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
