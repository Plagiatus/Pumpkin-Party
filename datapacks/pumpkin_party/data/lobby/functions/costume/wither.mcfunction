...
item replace entity @s armor.head with iron_nugget{CustomModelData:3,Unbreakable:1,display:{Name:'{"text":"Wither Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
