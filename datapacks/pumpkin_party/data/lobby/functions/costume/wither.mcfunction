...
item replace entity @s armor.chest with leather_chestplate{CustomModelData:1,Unbreakable:1,display:{Name:'{"text":"Wither Costume","italic":false}',color:14},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
#item replace entity @s armor.chest with leather_chestplate{CustomModelData:1,Unbreakable:1,display:{Name:'{"text":"Wither Costume","italic":false}',color:1513239},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
