...
item replace entity @s armor.chest with leather_chestplate{CustomModelData:1,Unbreakable:1,display:{Name:'{"text":"Zoglin Costume","italic":false}',color:15375001},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
