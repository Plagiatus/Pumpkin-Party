...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Shulker Costume","italic":false}',color:7},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
...
#item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Shulker Costume","italic":false}',color:15134893},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
