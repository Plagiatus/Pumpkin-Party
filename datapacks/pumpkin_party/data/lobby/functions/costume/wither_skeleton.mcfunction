...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Wither Skeleton Costume","italic":false}',color:3421236},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
