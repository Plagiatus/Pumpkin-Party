...
item replace entity @s armor.head with iron_nugget{CustomModelData:167,Unbreakable:1,display:{Name:'{"text":"Vindicator Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
