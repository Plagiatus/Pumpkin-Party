...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Bat Costume","italic":false}',color:5390368},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
