...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:45,Unbreakable:1,display:{Name:'{"text":"Zombified Piglin Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Zombified Piglin Costume","italic":false}',color:15104371},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
