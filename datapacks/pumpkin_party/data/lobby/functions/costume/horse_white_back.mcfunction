...
item replace entity @s armor.head with minecraft:iron_nugget{CustomModelData:6131,Unbreakable:1,display:{Name:'{"text":"White Horse Costume","italic":false}'},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
