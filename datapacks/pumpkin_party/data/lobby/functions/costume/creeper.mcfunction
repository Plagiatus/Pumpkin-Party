...
item replace entity @s armor.chest with leather_chestplate{Unbreakable:1,display:{Name:'{"text":"Creeper Costume","italic":false}',color:2},HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
