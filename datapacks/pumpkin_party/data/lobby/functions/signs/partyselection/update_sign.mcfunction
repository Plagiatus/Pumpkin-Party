...
execute if score #in_party tmp matches 6 run data merge block 383 70 500 {Text1:'{"text":"\\uEf12","color":"white"}',Text2:'""',Text3:'{"text":"(all minigames)","color":"dark_gray"}',Text4:'{"color":"black","text":"[click here]","clickEvent": {"action": "run_command","value": "function lobby:signs/minigame/party"}}]'}
