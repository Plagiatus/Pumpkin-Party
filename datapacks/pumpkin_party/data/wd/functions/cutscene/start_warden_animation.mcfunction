...
summon item_frame -1000 69 1016 {Item:{id:"minecraft:potion",Count:1b,tag:{CustomModelData:1,CustomPotionColor:8388880}},Facing:1b,Tags:["wd_warden_if"],Invisible:1b,Fixed:1b}
