...
execute if score #next wd_timer matches 0 as @a at @s run playsound block.note_block.xylophone master @s ~ ~ ~ 1 0.707107
...
execute if score #next wd_timer matches 1 as @a at @s run playsound block.note_block.xylophone master @s ~ ~ ~ 1 0.890899
...
execute if score #next wd_timer matches 2 as @a at @s run playsound block.note_block.xylophone master @s ~ ~ ~ 1 1.059463
...
execute if score #next wd_timer matches 3 as @a at @s run playsound block.note_block.xylophone master @s ~ ~ ~ 1 1.189207
